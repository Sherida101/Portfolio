...
fetch(baseUrl, {
  ...
  .then((txt) => {
    ...
    console.log("Fetching the Contributed Organisation Data.\n");
    fs.writeFile(
      "./src/shared/opensource/organisations.json",
  ...
  // SVG Logos are mostly used as icons below.
  // SVG Logos icons: https://icon-sets.iconify.design/logos/?category=Logos
